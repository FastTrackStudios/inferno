  ...
  async fn send_heartbeat(&mut self) {
    ...
    if let Some(freq_offset) = freq_offset_opt {
      ...
      /* bytes.write_bytes(&[
        ...
        0x00, 0x00, 0x01, 0xde, 0x00, 0x07, 0xdf, 0x17, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      ]); */
  
      /* bytes.write_bytes(&[
        0x00, 0x20, 0x80, 0x02, 0x00, 0x04, 0x00, 0x10,  H(ctr), L(ctr), 0x00, 0x00, 0x00, 0x02, 0x00, 0x00,
        0x00, 0x02, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0xa8, 0xab, 0xa8, 0xa4, 0xfe, 0xfe, 0x99, 0x9f
      ]); */
