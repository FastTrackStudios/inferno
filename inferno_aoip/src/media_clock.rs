...
fn timestamp_to_clock_value(ts: clock_steering::Timestamp) -> FineClock {
    (ts.seconds as FineClock)
        .wrapping_mul(1_000_000_000)
        .wrapping_add(ts.nanos as FineClock)
}
...
impl MediaClock {
    ...
    pub fn system_clock_duration_from_until(
        ...
        let duration_ns =
            (duration_in_tb as i64 * 1_000_000_000i64 / timebase_hz as i64) as FineClockDiff;
...
mod tests {
    ...
    fn timestamp_to_clock_value_basic() {
        let ts = clock_steering::Timestamp {
            seconds: 1,
            nanos: 500_000_000,
        };
    ...
    fn timestamp_to_clock_value_large() {
        ...
        let expected = (i64::MAX as u64)
            .wrapping_mul(1_000_000_000)
            .wrapping_add(999_999_999);
